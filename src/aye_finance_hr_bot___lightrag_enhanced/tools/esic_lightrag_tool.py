    ...
    def _run(self, query: str, employee_id: str) -> str:
        ...
        try:
            ...
            specialized_prompt = (
                ...
                f"Focus ONLY on ESIC, social security, and employment insurance information for employee {employee_id}. "
                f"Query: {query}. "
                f"Provide detailed ESIC information including ESIC IP number, dispensary details, "
                f"contribution calculations, ESIC card information, eligibility status, "
                f"medical care provisions, cash benefits, and procedural guidelines."
            )
