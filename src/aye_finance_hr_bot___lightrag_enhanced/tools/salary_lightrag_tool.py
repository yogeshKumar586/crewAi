...
"""
    ...
    def _build_specialized_prompt(self, query: str, employee_id: str) -> str:
        ...
        return (
            ...
            f"compensation, payroll, benefits, and payment-related information for "
            f"employee {employee_id}. Query: {query}. Provide detailed salary "
            f"information including basic salary, HRA, allowances, deductions, "
            f"net pay, gross pay, tax information, and any other compensation details. "
            f"If specific salary data is not available for this employee, clearly state that."
        )
